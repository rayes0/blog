...
** TODO On Second Order Belief                                  :philosophy:
:PROPERTIES:
:EXPORT_FILE_NAME: chained-belief
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :status inprogress
:END:
Inspired by a recent discussion I had in a Matrix chat room about chained attitudes relating to oneself, such as: "I believe that I feel cold", "I think that I know X", or other stylistic variants of "I believe that I believe X."
...
- [[/media][Media]]
  - [[/media#books][Books]]
  - [[/media#manga][Manga]]
  - [[/media#tv-anime-movies][TV/Anime/Movies]]
*** Notes
...
I typically go by the name ~rayes~ online. It's not my actual name, just a pseudonym. I'm a FOSS supporter, Linux enthusiast, musician, and hobbyist writer. I am fascinated particularly by the brain, psychology, specifically practical applications of these, as well as how they tie into media and culture. On the academic side of things, I am currently doing undergrad degrees in statistics and microbiology. My current research work involves applying [[https://en.wikipedia.org/wiki/Design_research][design research]] methods to qualitative data.
